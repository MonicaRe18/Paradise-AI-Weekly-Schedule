      ...
      <div className="no-print mt-4 flex flex-wrap items-center justify-between gap-3 pt-2">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          >
            ...
            <span>إعدادات اللوحة واللوجو</span>
          </button>

          {/* Download PDF Button */}
          <button
            onClick={onPrint}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-bold hover:from-blue-500 hover:to-cyan-500 text-xs transition-all shadow-md shadow-blue-900/30"
            title="تنزيل اللوحة كملف PDF بنفس الشكل والتصميم"
          >
